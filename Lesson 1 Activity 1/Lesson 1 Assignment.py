...
passenger_name = "David Ogiji"        # str - text
destination = "Canada"             # str - text
ticket_price = 430.00          # float - decimal number
number_of_tickets = 20        # int - whole number
...
print("Are more than 20 tickets booked?", number_of_tickets > 2)
